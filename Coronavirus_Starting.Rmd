...
# Load the data
corona_confirmed <- read_csv("corona_confirmed.csv")
corona_recovered <- read_csv("corona_recovered.csv")
corona_deaths <- read_csv("corona_deaths.csv")

# Inspect the data
head(corona_confirmed)
head(corona_recovered)
head(corona_deaths)
```
...
cases_north_0322 <- corona_confirmed %>%
  filter(Lat > 0) %>%
    select(`3/22/20`) %>%
      sum()
...
cases_aus_0322 <- corona_confirmed %>%
...
pct_north_0322 <- cases_north_0322/cases_0322 * 100

pct_aus_0322 <- cases_aus_0322/cases_0322 * 100
